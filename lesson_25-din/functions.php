<?php
/**
 * lesson_25-din functions and definitions
 *
...
if ( ! function_exists( 'lesson_25_din_setup' ) ) :
	/**
	 ...
	 */
	function lesson_25_din_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on lesson_25-din, use a find and replace
		 * to change 'lesson_25-din' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'lesson_25-din', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'lesson_25-din' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'lesson_25_din_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'lesson_25_din_setup' );
 ...
 */
function lesson_25_din_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'lesson_25_din_content_width', 640 );
}
add_action( 'after_setup_theme', 'lesson_25_din_content_width', 0 );
 ...
 */
function lesson_25_din_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'lesson_25-din' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'lesson_25-din' ),
...
add_action( 'widgets_init', 'lesson_25_din_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'lesson_25_din_scripts' );
